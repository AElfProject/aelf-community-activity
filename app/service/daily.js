...
module.exports = class TxsService extends Service {
  ...
  async getEffectiveTx(options) {
    ...
    const sqlList = {
      ...
      normalTransfer: 'select * from transactions_token where address_from=? and tx_status=? and method!="CrossChainTransfer" and method!="CrossChainReceiveToken" order by id DESC limit 1',
